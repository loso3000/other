...
-- [[ 颜色设置 ]]--
a = Map(name, translate('KuCat Theme Config'),  translate("<b>Set and manage theme main color scheme, activate menu and list background color, theme shortcut and other functions.</b></br>") .. 
