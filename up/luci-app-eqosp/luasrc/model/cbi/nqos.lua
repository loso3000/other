...
a = Map("nqos", translate("Timed speed limit"))
...
a.template = "nqos/index"

t = a:section(TypedSection, "nqos")
t.anonymous = true

e = t:option(DummyValue, "nqos_status", translate("Status"))
e.template = "nqos/nqos"
